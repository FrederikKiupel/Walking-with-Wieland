    ...
    overlay.innerHTML =
      '<div class="cam-inner">' +
        ...
        '<div class="cam-fallback" id="cam-fallback" hidden>' +
          ...
          '<label class="btn btn--brett cam-fallback__btn" for="cam-file-input">Foto aufnehmen</label>' +
          ...
          '<button class="btn btn--brett btn-sm cam-skip-btn" id="cam-skip" type="button">Ohne Foto weiter</button>' +
        '</div>' +
      '</div>';
    ...
    box.innerHTML =
      ...
      '<div class="lightbox__bar">' +
        ...
        '<div class="lightbox__actions">' +
          '<button class="btn btn--brett btn-sm" id="lb-save" type="button">Foto sichern</button>' +
          '<button class="btn btn--brett btn-sm" id="lb-del" type="button">Löschen</button>' +
        '</div>' +
